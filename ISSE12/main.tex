...
%%%%%%%%%%%%
%% MINE
%% \documentclass[twocolumn]{article}            % options: twocolumn, smallcondins
% ed, small
%%%%%%%%%%%%
...
%% \newcommand{\acknowledgements}[1]{\section*{#1}}
...
\and Sebastian Niller \\Evertz Microsystems \\ \url{sniller@evertz.com} 
\and Alwyn Goodloe \\ NASA \\\url{a.goodloe@nasa.gov}}

  %% \and  \and
  %% \\  \and Alwyn
  %% Goodloe\\National Institute of Aerospace\\\url{a.goodloe@nasa.gov}\footnote{The research contributed by
...
%%  \thispagestyle{fancy}
%% \chead{\small To appear in {\em Innovations in Systems and Software Engineering:
