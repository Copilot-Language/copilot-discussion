...
\begin{myfig}[ht!]
  ...
  \subfigure[]{
    \includegraphics[width=0.46\textwidth, trim=100 120 20 120,clip=true]{Figs/flight2_7_22_2011}
    \label{fig:onestuckprobe}
  }
  \subfigure[]{
    \includegraphics[width=0.46\textwidth, trim=100 120 20 120,clip=true]{Figs/flight2_8_5_2011}
    \label{fig:twostuckprobes}
  }
  \subfigure[]{
    \includegraphics[width=0.46\textwidth, trim=100 120 20 120,clip=true]{Figs/flight3_8_5_2011}
    \label{fig:threestuckprobes}
  }
  \caption{Logged pressure sensor, voted and averaged data.}
  \label{fig:pressuregraphs}
\end{myfig}
\todo{change text to match the colors}
