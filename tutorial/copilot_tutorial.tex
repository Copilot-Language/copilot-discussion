...
a C-targeting compiler, and a verifier front-end. In the following section, we will
...
Finally, Copilot includes a tool to generate a driver to prove the equivalence between the
copilot-c99 and copilot-sbv backends that each generate C~code (similar drivers
are planned for future backends).  To use the driver, first import the following
module:
%
\begin{code}
