...
a compiler targeting C, and a verifier front-end. In the following section, we will
demonstrate some of these tools and their usage. All the tools are shown in the Figure~\ref{fig:New toolchain}.
