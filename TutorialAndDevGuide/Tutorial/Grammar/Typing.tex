...
\infrule[Append] 
    {\Gamma \vdash ls : [a] \andalso \Gamma \vdash s : \texttt{Spec } a}
    {\Gamma \vdash ls ++ s : \texttt{Spec } a}
...
\infrule[op2Fractional]
    {\Gamma \vdash x :  \texttt{Fractional } \tau \Rightarrow\texttt{Stream }  \tau \andalso \Gamma \vdash y : \texttt{Fractional } \tau  \Rightarrow \texttt{Stream }  \tau \andalso op \in \{ \texttt{/} \}} 
    {\Gamma  \vdash {op~x~y : \texttt{Stream } \tau}}
