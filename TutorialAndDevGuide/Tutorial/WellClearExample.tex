...
Well Clear is a mathematically defined way of preventing collisions in the air. The well-clear boundary 
sets the \emph{well-clear violation volume}, such that "aircraft pairs jointly occupying this volume are 
considered to be in a well-clear violation" [cite DAEDALUS].
