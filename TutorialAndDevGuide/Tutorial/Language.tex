...
%Up to now, only one has been
%implemented, which does a beta expansion where it is put.
%This would result in splitting the AST
...
%labeled has to be of the \texttt{Typed} typeclass). 
