...
\section*{Abstract}
{
\small We descirbe an approach to assured runtime verificaition. Our apporach is illustrated using the example from airspace management. 
}
