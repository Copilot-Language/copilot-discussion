\section{Introduction}~\label{sec:intro} Safety-critical systems, such
...
%\paragraph{Outline:} This paper proceeds as follows. Section\ref{sec:copilot} introduces the Copilot RV
%framework targeted at safety-critical 
%systems. Sections~\ref{sec:req} and~\ref{sec:observ} focus
%%on the problems of  specifying
%high-assurance monitors. Section~\ref{sec:trace} i
