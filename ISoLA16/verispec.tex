...
the proposition. Currently, proof tools based on
Satisfiability Modulo Theories (\textsc{smt})   used to discharge
...
but combined with testing they were enough to argue that we got the
