...
\end{minted}
	...
	\begin{figure}[!htb]
		\centering
		\includegraphics[width=70mm]{images/TCASRA1.jpg}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[height=80mm]{images/WCV/graph.pdf}\\
...
\begin{figure}[ht!]
	...
	(GUI) edge node {} (AL);
	\end{tikzpicture}
	\label{fig:Monitor structure}
	\caption{The overall structure of the monitor}
\end{figure} 
	...
	The author would like to thank Dr. Alwyn Goodloe for his supervising, Dr. Lee Pike, Dr. Levent Erkok, Dr. César A. Muñoz, Dr. Andrew Smith, Dr. Natasha Neogi, Dr. Mariano Moscato, Dr. Jean-Christophe Filliâtre.
