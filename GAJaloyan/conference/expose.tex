...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item Prover mode : 2140 files verified in xxx
		\item Compiler mode : 262 files compiled in 10 sec
	\end{itemize}
	
	A unit test was written for the generated code in C99, but lacks some domain specific examples.
