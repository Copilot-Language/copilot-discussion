...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item Prover mode : xxx files verified in xxx
		\item Compiler mode : xxx files compiled in xxx
	\end{itemize}
...
\begin{frame}[fragile]
	...
	There remains the main.c file, and producing a complete executable, for testing it.
	\begin{itemize}
